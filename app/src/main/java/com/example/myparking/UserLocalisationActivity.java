...
public class UserLocalisationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    Button btnPark1,btnPark2,btnPark3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPark1 = findViewById(R.id.but_park1);
        btnPark2 = findViewById(R.id.but_park2);
        btnPark3 = findViewById(R.id.but_park3);
            ...
            public void onLocationChanged(Location location) {
                ...
                btnPark1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        String url = getUrl(pl3.getPosition(),pl1.getPosition(),"driving");
                        new FetchURL(UserLocalisationActivity.this).execute(getUrl(userlocalisation.getPosition(), pl2.getPosition(), "driving"), "driving");
                    }
                });
                     btnPark2.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String url = getUrl(userlocalisation.getPosition(),pl1.getPosition(),"driving");
                            new FetchURL(UserLocalisationActivity.this).execute(getUrl(userlocalisation.getPosition(), pl2.getPosition(), "driving"), "driving");
                        }
                    });
                        btnPark3.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                String url = getUrl(userlocalisation.getPosition(),pl3.getPosition(),"driving");
                                new FetchURL(UserLocalisationActivity.this).execute(getUrl(userlocalisation.getPosition(), pl3.getPosition(), "driving"), "driving");
                            }
